...
class DQN(nn.Module):
    ...
    def __init__(self, screen_shape,n_directions, n_actions):
        ...
        self.layer1a = nn.Conv2d(n_observations, 128)
...
# state is a dict: 
# state['screen'] is the matrix representing the screen
# state['direction'] is one of 4 numbers (0,1,2,3) representing the direction the head is currently going
screen_shape = env.observation_space['screen'].shape # is a tuple
n_directions = env.observation_space['direction'].n # is an int
